...
public class InfiniteHeatBlock extends BlockMagneticraft2 {
    public InfiniteHeatBlock(Properties properties) {
        super(properties);
    }
    ...
    public ActionResultType use(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult trace) {
        if (world.isClientSide) {
            ...
            if (tileEntity instanceof TileEntityMagneticraft2){
                player.sendMessage(new StringTextComponent( ((TileEntityMagneticraft2) tileEntity).getHeatStorage() + " heat stored"), player.getUUID());
            }
        }
